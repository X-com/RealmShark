 ...
 * @since pcap4j 0.9.1
 */
public final class IpV4PacketCustom extends AbstractPacket implements IpPacket {
...
//    private static final Logger logger = LoggerFactory.getLogger(IpV4PacketCustom.class);
     ...
     */
    public static IpV4PacketCustom newPacket(byte[] rawData, int offset, int length)
            throws IllegalRawDataException {
        ByteArrays.validateBounds(rawData, offset, length);
        return new IpV4PacketCustom(rawData, offset, length);
    }

    private IpV4PacketCustom(byte[] rawData, int offset, int length) throws IllegalRawDataException {
...
//            logger.debug("Total Length is 0. Assuming segmentation offload to be working.");
    ...
    private IpV4PacketCustom(Builder builder) {
        if (builder == null
    ...
    public static final class Builder extends AbstractBuilder
            implements ChecksumBuilder<IpV4PacketCustom>, LengthBuilder<IpV4PacketCustom> {
        ...
        /** @param packet packet */
        public Builder(IpV4PacketCustom packet) {
        ...
        @Override
        public IpV4PacketCustom build() {
            return new IpV4PacketCustom(this);
        }
    }
