...
import packets.packetcapture.networktap.pcap4j.IpV4Packet.IpV4Tos;
...
public final class StaticIpV4TosFactory implements PacketFactory<IpV4Packet.IpV4Tos, NotApplicable> {
  ...
  @Override
  public IpV4Packet.IpV4Tos newInstance(byte[] rawData, int offset, int length, NotApplicable... numbers) {
    ByteArrays.validateBounds(rawData, offset, length);
    return IpV4Rfc1349Tos.newInstance(rawData[offset]);
  }
}
