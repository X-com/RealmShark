...
public final class ByteArrays {
     ...
     */
    public static byte[] getMacAddress(byte[] array, int offset) {
     ...
     * @return a new MacAddress object.
     */
    public static byte[] getMacAddress(byte[] array, int offset, ByteOrder bo) {
        validateBounds(array, offset, MAC_SIZE_IN_BYTES);
        ...
        if (bo.equals(LITTLE_ENDIAN)) {
            return getByAddress(reverse(getSubArray(array, offset, MAC_SIZE_IN_BYTES)));
        } else {
            return getByAddress(getSubArray(array, offset, MAC_SIZE_IN_BYTES));
        }
    }

    public static byte[] getByAddress(byte[] address) {
        if (address.length != MAC_SIZE_IN_BYTES) {
