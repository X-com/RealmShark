...
public enum ClassIDType {
    ...
    private static final HashMap<Integer, ClassIDType> ENUM_BY_INDEX = new HashMap<>();

    static {
        try {
            for (ClassIDType o : ClassIDType.values()) {
    ...
    public static ClassIDType byOrdinal(int index) {
