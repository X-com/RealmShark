...
//            fps();
            ...
            if (firstDisplay && !model.inRealm()) {
                ...
                String s = String.format("%s x:%d y:%d %s %s %s", model.getDungeonTime(), model.getIntPlayerX(), model.getIntPlayerY(), model.getServerName(), model.getRealmName(), model.extraInfo());
